...
public class RegistrarPersonaAdministrador extends javax.swing.JFrame {
    ...
    public void RegistarProducto() {
        ...
        res = CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodo(nombre);
        res1 = CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodo(marca);
        res2 = CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodoSerial(serial);
    ...
    public void RegistrarPersona() {
        ...
        res = CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodo(nombre);
        res1 = CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodo(apellido);
        res2 = CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodoLetra(cedula);
        res3 =  CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodoDireccion(direccion);
        res4 = CapaLogicaNegocio.Helpers.HelperValidacion.ValidarTodoSerial(nom_img);
